...
```{r hypotenuse_code-check, eval=is_tutorial}
grade_conditions(
...
```{r hypotenuse_function-check, eval=is_tutorial}
grade_conditions(
...
```{r triangle_area_function, exercise=TRUE, eval=is_tutorial}
_______ <- function(a, b) {
  area <- _______
  return(area)
}
...
```{r triangle_area_function-check, eval=is_tutorial}
grade_conditions(
