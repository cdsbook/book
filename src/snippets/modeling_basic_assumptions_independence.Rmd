...
For comparison, think about measuring the height of all the students in this class: one student's height does not significantly affect anyone else's height, so these observations are all independent.
