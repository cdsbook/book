...
```{r qzxwzhahunefufkc, exercise = TRUE, eval=is_tutorial}
x <- "ninety-nine"
...
```{r qzxwzhahunefufkc-solution, eval=is_tutorial}
x <- 99
...
```{r qzxwzhahunefufkc-check, eval=is_tutorial}
# check code
...
```{r dxkfdawzkzncnspv, exercise = TRUE, eval=is_tutorial}
if(TRUE){
...
```{r dxkfdawzkzncnspv-hint-1, eval=is_tutorial}
# hint text
""
```

```{r dxkfdawzkzncnspv-hint-2, eval=is_tutorial}
# hint text
""
```

```{r dxkfdawzkzncnspv-solution, eval=is_tutorial}
if(FALSE){
  print("the condition was TRUE")
} else{
  print("the expression was FALSE")
...
```{r dxkfdawzkzncnspv-check, eval=is_tutorial}
# check code
gradethis::grade_code()
```
