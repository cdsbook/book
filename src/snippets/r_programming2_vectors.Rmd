...
```{r aiwkmkcqayvrufhf, exercise = TRUE, eval=is_tutorial}

```

```{r aiwkmkcqayvrufhf-hint-1, eval=is_tutorial}
# hint text
"Try using the `:` operator"
```

```{r aiwkmkcqayvrufhf-solution, eval=is_tutorial}
2:250
```

```{r aiwkmkcqayvrufhf-check, eval=is_tutorial}
# check code
