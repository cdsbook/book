...
# Literate Programming {#sec-literate-programming-chapter}
...
## Markdown Text {#sec-markdown-formatting}
...
## Images & figures {#sec-markdown-images}
...
```{r, echo=FALSE, results='asis'}
pdf_dev_comment("
TODO: Add code chunk options section: brief, maybe just echo, and 1 or two more. Diff between Quarto and RMarkdown (comment vs curly brackets)
")
```
<!--
