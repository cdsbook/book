...
4. Next we need to install a program called \latex (this will turn our files containing R code into nicely formatted PDFs).
...
5. One last step is to store your GitHub account details in RStudio. There are a few steps to this, so follow along carefully.
