...
Each pixel in our image will be an input to the model. Since there are 28 by 28 pixels in each images, then we will need $28 \times 28 = 784$ input nodes in any artificial neural network that we create.
